  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 pt-4 pb-2">
        ...
        <button className="text-gray-400 hover:text-gray-600 text-xl font-bold px-2 py-1 rounded-full transition-colors" title="Close">
          ×
        </button>
      </div>
      {/* Editor */}
      <div className="px-4 pb-2">
        ...
        <div className="flex items-center justify-between bg-gray-50 rounded-lg px-2 py-2 mt-2 mb-2 border border-gray-200">
          ...
          <div className="flex items-center gap-2">
            <button className="w-8 h-8 flex items-center justify-center rounded-full bg-green-100 hover:bg-green-200" title="Photo/Video">
            ...
            <button className="w-8 h-8 flex items-center justify-center rounded-full bg-blue-100 hover:bg-blue-200" title="Tag people">
            ...
            <button className="w-8 h-8 flex items-center justify-center rounded-full bg-yellow-100 hover:bg-yellow-200" title="Feeling/Activity">
            ...
            <button className="w-8 h-8 flex items-center justify-center rounded-full bg-red-100 hover:bg-red-200" title="Live video">
            ...
            <button className="w-8 h-8 flex items-center justify-center rounded-full bg-gray-200 hover:bg-gray-300" title="More">
              <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="5" cy="12" r="2"/><circle cx="12" cy="12" r="2"/><circle cx="19" cy="12" r="2"/></svg>
            </button>
          </div>
        </div>
